  ...
  return (
    <>
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-[252px] right-4 sm:right-6 z-[55] w-[260px] rounded-2xl overflow-hidden shadow-2xl shadow-black/20 border border-gray-100 dark:border-gray-800 bg-white dark:bg-[#12121f]"
          >
            {/* Header */}
      ...
      <motion.button
        ...
        className="fixed bottom-[170px] right-4 sm:right-6 z-[56] w-14 h-14 rounded-2xl bg-white dark:bg-[#1a1a2a] text-[#1428A0] dark:text-white shadow-xl shadow-black/15 border border-gray-100 dark:border-gray-700 flex items-center justify-center hover:shadow-2xl hover:border-[#1428A0]/30 transition-all"
