  ...
  return (
    <>
      ...
      <motion.button
        ...
        className={`fixed bottom-24 right-5 z-50 w-14 h-14 rounded-full shadow-xl flex items-center justify-center transition-colors ${
          isOpen
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-40 right-5 z-50 w-[380px] max-w-[calc(100vw-40px)] h-[540px] max-h-[70vh] rounded-2xl shadow-2xl overflow-hidden flex flex-col bg-white dark:bg-[#14141f] border border-gray-200 dark:border-gray-800"
          >
            {/* Header */}
